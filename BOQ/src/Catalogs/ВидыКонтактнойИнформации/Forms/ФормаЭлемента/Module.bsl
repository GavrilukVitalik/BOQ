...
Процедура ПроверитьЭлементыФормы(Форма)
	...
	Если Не Форма.Объект.МожноИзменятьСпособРедактирования Тогда
		...
		Форма.Элементы.АдресТолькоУкраинский.Доступность = Ложь;
		Возврат;
	...
	Если ЭтоАдрес И Форма.Объект.РедактированиеТолькоВДиалоге Тогда
		Форма.Элементы.АдресТолькоУкраинский.Доступность = Истина;
	Иначе
		Форма.Элементы.АдресТолькоУкраинский.Доступность = Ложь;
		Если Форма.Объект.АдресТолькоУкраинский Тогда
			Форма.Объект.АдресТолькоУкраинский = Ложь;
		КонецЕсли;
	КонецЕсли;
